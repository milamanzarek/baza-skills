...
description: "Surface the doubts and resistance a specific customer will feel and neutralize them in advance using inoculation and autonomy-preserving language, without triggering reactance. Use when a funnel or pitch keeps failing on the same objections."
risk: safe
source: community
