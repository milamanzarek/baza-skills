...
description: "Design email nurture and multi-touch sequences using curiosity loops, reciprocity, commitment, and emotional pacing so each touch prepares the next. Use when a sequence needs a step-by-step persuasion arc."
risk: safe
source: community
