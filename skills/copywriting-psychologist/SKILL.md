...
description: "Write conversion copy using evidence-based psychological mechanisms (awareness-stage matching, framing, credibility, narrative) to create desire and drive action. Use when copy needs stronger psychological framing or feels generic."
risk: safe
source: community
