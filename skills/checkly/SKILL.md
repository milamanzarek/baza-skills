...
allowed_tools: Bash(npx:checkly:*) Bash(npm:install:*)
metadata:
  author: checkly
---
...
Use `npx checkly skills install` to install this skill into your project (supports Codex, Cursor, Codex and more).
