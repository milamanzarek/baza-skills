...
description: "Map color, typography, spacing, imagery, and layout to specific target emotions and conversion goals. Use when visuals should reinforce a feeling or support persuasion rather than act as decoration."
risk: safe
source: community
