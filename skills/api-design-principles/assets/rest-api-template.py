...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:3000", "https://api.example.com"], # TODO: Update this with specific origins in production
    allow_credentials=True, # TODO: Set to True if you need cookies/auth headers, but restrict origins
    allow_methods=["*"],
    allow_headers=["*"],
)
