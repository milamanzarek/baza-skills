...
content_description: An animation of the Podcasts app icon for iOS. As the animation plays, the icon rotates to the side and expands to show how layers are separated. It then collapses and returns to its original position. 
...
content_description: An animation of the Photos app icon in tvOS moving to show the parallax effect. 
...
content_description: An animation of the Photos app icon in visionOS moving to show the parallax effect. 
