...
description: "Uncover the functional, emotional, and social jobs a customer hires a product to do, including switch triggers and competing alternatives. Use when positioning or messaging should be anchored in real customer progress."
risk: safe
source: community
