...
description: "Design first-use experiences that create early wins, psychological investment, and habit-formation triggers to reduce drop-off. Use when onboarding needs to build momentum and retention."
risk: safe
source: community
