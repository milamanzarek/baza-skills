...
description: "Identify where loss framing outperforms gain framing and apply prospect-theory framing to create credible urgency without fear-mongering. Use when a message should emphasize the cost of inaction."
risk: safe
source: community
