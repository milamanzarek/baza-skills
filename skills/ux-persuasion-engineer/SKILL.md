...
description: "Apply choice architecture and behavioral design to UX flows to reduce friction, build commitment, and guide the intended behavior without coercion. Use when conversion friction comes from interaction design, not copy."
risk: safe
source: community
