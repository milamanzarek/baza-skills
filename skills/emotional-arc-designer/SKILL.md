...
description: "Map the deliberate emotional journey a customer should travel across content, an email sequence, a deck, or a product flow, from entry emotion to the state needed for action. Use when content needs an engineered feeling progression."
risk: safe
source: community
