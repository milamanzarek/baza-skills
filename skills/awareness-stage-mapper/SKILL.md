...
description: "Diagnose where an audience sits on the awareness ladder (unaware to most aware) and calibrate message register, sequencing, and persuasion strategy to that stage. Use before writing campaign messaging or offers."
risk: safe
source: community
